...
async function callOpenAICompat(baseUrl, config, messages) {
...
export async function testConnection(config) {
    const minMessages = [{ role: 'user', content: 'Reply with just "OK".' }];
    try {
...
export async function chatComplete(config, messages) {
